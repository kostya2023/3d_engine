...
impl VecOperations for Vec3 {
	...
	fn clamp(self, min: Self, max: Self) -> Self {
		Self { x: self.x.clamp(min.x, max.x), y: self.y.clamp(min.y, max.y), z: self.z.clamp(min.z, max.z) }
	}
}
...
mod test {
	...
	fn test_vec3_display() {
		...
		let b = Vec3 { x: 1.5, y: 0.25, z: 0.125 };
		assert_eq!(format!("{}", b), "Vec3 (1.5, 0.25, 0.125)");

		let c = Vec3 { x: 1.1234567890123, y: 0.0000000001, z: 3.141592653589 };
		assert_eq!(format!("{}", c), "Vec3 (1.123456789, 0.0000000001, 3.1415926536)");
	...
	#[test]
	fn test_vec3_add() {
		let a = Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		let b = Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		assert_eq!(a + b, Vec3 { x: 4.0, y: 4.0, z: 4.0})
	}
	...
	fn test_vec3_sub() {
		let a = Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		let b = Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		assert_eq!(a - b, Vec3 { x: 0.0, y: 0.0, z: 0.0 })
	}
	...
	fn test_vec3_mulscalar() {
		let a = Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		assert_eq!(a * 2.0, Vec3 { x: 4.0, y: 4.0, z: 4.0 })
	}
	...
	fn test_vec3_cross() {
		...
		assert_eq!(a.cross(b), Vec3 { x: 0.0, y: 0.0, z: 1.0 });
		assert_eq!(b.cross(a), Vec3 { x: 0.0, y: 0.0, z: -1.0 });
	}
	...
	fn test_vec3_div() {
		let a = Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		let b = Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		assert_eq!(a / b, Vec3 { x: 1.0, y: 1.0, z: 1.0 })
	}

	#[test]
	fn test_vec3_divscalar() {
		let a = Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		assert_eq!(a / 2.0, Vec3 { x: 1.0, y: 1.0, z: 1.0 })
	}

	#[test]
	fn test_vec3_neg() {
		let a = Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		assert_eq!(-a, Vec3 { x: -2.0, y: -2.0, z: -2.0 })
	}

	#[test]
	fn test_vec3_addasign() {
		let mut a = Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		a += Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		assert_eq!(a, Vec3 { x: 4.0, y: 4.0, z: 4.0 })
	}
	...
	fn test_vec3_divassign() {
		let mut a = Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		a /= Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		assert_eq!(a, Vec3 { x: 1.0, y: 1.0, z: 1.0 })
	}
	...
	#[test]
	fn test_vec3_norm() {
		let a = Vec3 { x: 2.0, y: 2.0, z: 2.0 }.norm();
		assert!((a.length() - 1.0).abs() < f64::EPSILON)
	}
	...
	fn test_vec3_lerp() {
		...
		let b = Vec3 { x: 2.0, y: 2.0, z: 2.0 };
		assert_eq!(a.lerp(b, 0.5), Vec3 { x: 1.0, y: 1.0, z: 1.0 })
	}
	...
	fn test_vec3_min() {
		...
		assert_eq!(a.min(b), Vec3 { x: 0.0, y: 0.0, z: 0.0 })
	}
	...
	fn test_vec3_max() {
		let a = Vec3 { x: 0.0, y: 0.0, z: 0.0 };
		let b = Vec3 { x: 1.0, y: 1.0, z: 1.0 };
		assert_eq!(a.max(b), Vec3 { x: 1.0, y: 1.0, z: 1.0 })
	}

	#[test]
	fn test_vec3_clamp() {
		let max = Vec3 { x: 1.0, y: 1.0, z: 1.0};
		let min = Vec3 { x: -1.0, y: -1.0, z: -1.0 };

		let out_min = Vec3 { x: -2.0, y: -2.0, z: -2.0 };
		let mid = Vec3 { x: 0.0, y: 0.0, z: 0.0 };
		let out_max = Vec3 { x: 2.0, y: 2.0, z: 2.0 };
        
		let mixed_out_min = Vec3 { x: -2.0, y: 0.0, z: 2.0 };
		let mixed_out_max = Vec3 { x: 2.0, y: 0.0, z: -2.0 };

		assert_eq!(out_min.clamp(min, max), Vec3 { x: -1.0, y: -1.0, z: -1.0});
		assert_eq!(mid.clamp(min, max), Vec3 { x: 0.0, y: 0.0, z: 0.0 });
		assert_eq!(out_max.clamp(min, max), Vec3 { x: 1.0, y: 1.0, z: 1.0 });

		assert_eq!(mixed_out_min.clamp(min, max), Vec3 { x: -1.0, y: 0.0, z: 1.0 });
		assert_eq!(mixed_out_max.clamp(min, max), Vec3 { x: 1.0, y: 0.0, z: -1.0 });
	}
}
